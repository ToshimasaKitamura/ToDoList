...
public class UpdateServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int todoId = Integer.parseInt(request.getParameter(constant.Parameters.TODO_ID));
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    String todo = request.getParameter(constant.Parameters.TODO);
	    Date timeLimit = Date.valueOf(request.getParameter(constant.Parameters.TIME_LIMIT));
